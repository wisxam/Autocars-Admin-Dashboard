...
const CarType = () => {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/showcartype")
    .then((data) => data.json())
  ...
  const handleDeleteCarType = (id) => {
    const url = "http://127.0.0.1:8000/api/deleteCarType"+"/"+id
                    ...
                    <div color="blue">
                      ...
                      <div>
                        <Button style={{ 
                          ...
                          onClick={() => handleDeleteCarType(id)}>< CheckIcon /></Button>
                        <Button style={{ 
                          background: "none",
                          color: "inherit",
                          border: "none",
